...
test:
    ...
    just ci-dc exec -T -u$UID web pytest --verbose --github-report || exit 1
    just ci-dc exec -T -u$UID web pytest --verbose --github-report --no-cov nuremberg/documents/browser_tests.py || exit 1
