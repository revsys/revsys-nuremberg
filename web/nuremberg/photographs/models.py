...
class Photograph(models.Model):
    ...
    inscription = models.CharField(
        db_column='Inscription', max_length=2000
    )  # Field name made lowercase.

    year_taken = models.CharField(
        db_column='Date', max_length=100, blank=True, null=True
    )  # Field name made lowercase.
    image_url = models.CharField(
        db_column='FullImageURL', unique=True, max_length=100
    )  # Field name made lowercase.
    thumb_url = models.CharField(
        db_column='ThumbnailURL', max_length=100
    )  # Field name made lowercase.
    material_type = models.CharField(
        db_column='MaterialType', max_length=100
    )  # Field name made lowercase.
    via_id = models.CharField(
        db_column='LocalSystemID', max_length=200, blank=True, null=True
    )  # Field name made lowercase.
    created_at = models.DateTimeField(
        db_column='RecordCreated'
    )  # Field name made lowercase.
